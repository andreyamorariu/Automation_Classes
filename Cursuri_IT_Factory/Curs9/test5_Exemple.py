...
class Test2(unittest.TestCase):
    ...
    def test_url(self):
        self.chrome.find_element(*self.CONTACT_US).click()# se gaseste un element-> se da click pe el"contact us->ajungem pe un nou url
    ...
    def test_elem_visible(self):
        ...
        elem = self.chrome.find_element(*self.ERROR_MESSAGE) #salvam eroarea ca element(eroarea)
        self.assertTrue(elem.is_displayed(), 'Submit btn nu e vizibil')#afisam mai jos ca exista eroarea